        ...
        <div className="flex justify-between items-center">
          ...
          <div className="relative flex gap-3 p-1 border-[2px] border-white rounded-full">
            ...
            <button
              ...
              className={`select-none active:bg-gray-600/60 rounded-full z-20 text-[0.8rem] sm:text-base py-1 px-2 sm:px-5 font-semibold tracking-wide ${
